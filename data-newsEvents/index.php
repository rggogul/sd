...
?>
  ...
  ?>
  <tr>
    <td class="projects_project_type"><div align="center">News / Events</div></td>
  </tr>
  <tr>
    <td>
    <form method="post" name="formInsert" onsubmit="return validate()" action="news_insertion.php">
    <table width="100%" border="0" cellspacing="1" cellpadding="5">
          <tr> 
            <td class="body_title12px">Enter New Project </td>
            <td><input name="news_txt" type="text" class="dropbox" id="project_name" size="30" ></td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> <input name="Submit" type="submit" class="button" value="Add "></td>
          </tr>
          <tr> 
