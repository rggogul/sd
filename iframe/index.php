...
{
	document.getElementById('innerframe').src = "view.php";
}
...
?>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="5">
          ...
          <tr> 
            <td colspan="2" align="center"> <a href="view.php"><input name="viewSubmit" type="button" class="button" value="View"></a></td>
          </tr>
          <tr> 
            <td colspan="2" align="center"> <a  onclick="refreshiframe()"><input name="iframe_btn" type="button" class="button" value="View Iframe"></a></td>
          </tr>
      </table>
      </form>     
       </td>
  ...
  <iframe id="innerframe" width="100%" height="400" frameborder="0">
  </iframe>
</body>
</html>
